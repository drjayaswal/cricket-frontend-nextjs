...
const Navbar = () => {
  ...
  return (
    <>
      <div
        className={cn(
          "max-w-screen w-full mx-auto bg-background/60 border-b border-white/20 backdrop-blur-sm px-5 max-sm:p-0 flex justify-between items-center transition-normal duration-500"
        )}
      >
