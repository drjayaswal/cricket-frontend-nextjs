...
// Type definitions for the cricket match data
interface Wicket {
  batsmanId: number
  batsmanName: string
  wicketNumber: number
...
// Use the imported data for match information
const matchLiveScore = data

/**
 * MatchPage Component
 *
 * Displays detailed cricket match information including:
 * - Match status and summary
 * - Team statistics
 * - Batting, bowling, and wicket details
 * - Player cards and detailed player information
 */
