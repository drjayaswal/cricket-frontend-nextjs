                        ...
                        <tbody>
                          {transactions.map((transaction) => (
                            ...
                            >
                              ...
                              <td className="px-4 py-4 text-sm text-gray-300">
                                <div className="flex items-center">
                                  {gettxnPaymentMethodIcon(
                                    transaction.txnPaymentMethod
                                  )}
                                  <span className="ml-2">
                                    {transaction.txnPaymentMethod}
                                  </span>
                              ...
                              <td
                                className={`whitespace-nowrap px-4 py-4 text-right text-sm font-medium ${transaction.txnType === "deposit"
                                  ? "text-green-400"
                                  : "text-orange-400"
                                  }`}
                              >
